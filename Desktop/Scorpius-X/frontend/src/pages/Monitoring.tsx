          ...
          {[
            ...
            >
              ...
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <motion.div
                  className={`text-sm flex items-center gap-1 font-mono ${metric.trend === "up" ? "text-[#00ff88]" : "text-[#00ff88]"
                    }`}
                  style={{
          ...
          <div className="flex gap-4 mb-6">
            {[
              ...
              <motion.button
                ...
                className={`px-6 py-3 rounded-2xl font-mono font-bold transition-all duration-300 flex items-center gap-3 ${activeTab === tab.id
